...
#define _HORI_STATIC_ASSERT_MAKE_FIELD_NAME(_expr, ...) _HORI_IIF(_HORI_VA_ARGS_IS_EMPTY(__VA_ARGS__))(_HORI_STATIC_ASSERT_FIELD_NAME, _HORI_VA_ARG_0(__VA_ARGS__))
